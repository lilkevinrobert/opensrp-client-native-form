...
public class MaskEditTextTextWatcher implements TextWatcher, View.OnFocusChangeListener {
    ...
    public MaskEditTextTextWatcher(String stepName, JsonFormFragment formFragment, View view) {
    ...
    public synchronized void afterTextChanged(Editable editable) {
        ...
        if (editable != null && ((MaskedEditText)mView).getRawText().equals("")) {
            return;
        }
    ...
    protected boolean isRedundantRepetition(String text) {
